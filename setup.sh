...
# Core APIs, libraries, and mod dependencies required by other mods
# ============================================================================
echo "==> Libraries & Dependencies"
add_mod "Architectury API" "architectury-api" "architectury-api" "419699"                   # Cross-platform mod library
add_mod "Brandon's Core" "brandons-core" "brandons-core" "231382"                       # Required library for Draconic Evolution
...
add_mod "Cucumber Library" "cucumber" "cucumber" "272335"                           # Required library for Mystical Agriculture
...
add_mod "Placebo" "placebo" "placebo" "283644"                                     # Required library for Hostile Neural Networks
add_mod "SuperMartijn642's Core Lib" "supermartijn642s-core-lib" "rOUBggPv" "454372" # Library for various mods
add_mod "ZeroCore 2" "zerocore" "" "267602"                                # Multiblock reactor library

# ============================================================================
# CORE INFRASTRUCTURE
# Power generation, storage systems, transport and logistics
# ============================================================================
...
# Create mechanical systems, industrial processing, advanced machinery
# ============================================================================
echo "==> Technology & Automation"
...
# ============================================================================
# MAGIC & MYSTICAL
# Magic-focused mods including nature magic, mystical agriculture, and end-game magic
# ============================================================================
echo "==> Magic & Mystical"
...
# ============================================================================
# WORLD & EXPLORATION
# Biome mods, dimension mods, structure generation, exploration tools
# ============================================================================
...
# ============================================================================
# QUALITY OF LIFE
# JEI integration, utilities, inventory management, UI/UX improvements
# ============================================================================
...
# ============================================================================
# FOOD & COOKING
# Farming, cooking systems, and food-related mods
# ============================================================================
echo "==> Food & Cooking"
...
# ============================================================================
# TOOLS & COMBAT
# Tinkers' Construct, building tools, combat enhancements
# ============================================================================
echo "==> Tools & Combat"
...
# ============================================================================
# MINING & RESOURCES
# Resource generation, ore processing, storage compression
# ============================================================================
echo "==> Mining & Resources"
...
# Optimization mods and shader support
# ============================================================================
echo "==> Performance & Rendering"
